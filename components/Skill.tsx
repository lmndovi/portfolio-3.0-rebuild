  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.div
        ...
        className="relative h-16 w-16 rounded-full overflow-hidden md:h-20 md:w-20 xl:w-20 xl:h-20 filter group-hover:grayscale transition duration-300 ease-in-out"
      >
        <Image
