  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-gray-500 object-cover w-16 h-16 md:h-20 md:w-20 xl:w-24 xl:h-24 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
